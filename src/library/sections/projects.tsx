...
const projects = [
  {
    title: 'Sistema de Auditoria Pública',
    description: 'Plataforma completa para gestão de auditorias governamentais',
    longDescription: 'Sistema desenvolvido para o governo do estado, utilizado por mais de 200 auditores. Inclui módulos de planejamento, execução e relatórios de auditorias, com workflow customizado e dashboards analíticos.',
    ...
    type: 'privado',
    impact: '+200 auditores utilizam diariamente',
  },
  {
    title: 'Plataforma Educacional Mobile',
    description: 'App educacional com mais de 30 mil alunos ativos',
    longDescription: 'Aplicativo mobile para educação à distância, com videoaulas, exercícios interativos, gamificação e sistema de badges. Integrado com API RESTful e sistema de notificações push.',
    ...
    type: 'privado',
    impact: '+30 mil usuários ativos',
  },
  {
    title: 'Infraestrutura Cloud Serverless',
    description: 'Migração de infraestrutura para arquitetura serverless na AWS',
    longDescription: 'Projeto de modernização de infraestrutura legada para arquitetura serverless, utilizando Lambda, API Gateway, DynamoDB e S3. Redução de 60% nos custos operacionais.',
    ...
    type: 'privado',
    impact: '60% redução de custos',
  },
  {
    title: 'Portal Corporativo Interno',
    description: 'Sistema de gestão interna com múltiplos módulos integrados',
    longDescription: 'Portal desenvolvido para centralizar processos internos de uma empresa, incluindo RH, financeiro, projetos e comunicação interna. Interface moderna com React e backend robusto.',
    ...
    type: 'privado',
    impact: '500+ colaboradores',
  },
  {
    title: 'Pipeline CI/CD Otimizado',
    description: 'Automação completa de deploy com GitLab CI e Docker',
    longDescription: 'Implementação de pipeline CI/CD automatizado para múltiplos projetos, incluindo testes automatizados, análise de código, build e deploy em múltiplos ambientes.',
    ...
    type: 'autoral',
    impact: 'Deploy time: 15min → 3min',
  },
  {
    title: 'Dashboard Analytics em Tempo Real',
    description: 'Visualização de dados com atualização em tempo real',
    longDescription: 'Dashboard com métricas e KPIs atualizados em tempo real usando WebSockets. Interface rica com gráficos interativos e filtros avançados.',
    image: 'https://images.unsplash.com/photo-1665470909939-959569b20021?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjB3ZWIlMjBkYXNoYm9hcmR8ZW58MXx8fHwxNzYxNjcwMDUzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    stack: ['React', 'WebSocket', 'Python', 'Redis'],
    type: 'autoral',
    impact: 'Dados em tempo real',
  },
];
              ...
              <Dialog>
                      ...
                      <div className="absolute top-4 right-4">
                        <Badge variant={project.type === 'autoral' ? 'default' : 'secondary'}>
                          {project.type === 'privado' ? (
                            ...
                            <><Globe className="w-3 h-3 mr-1" /> Autoral</>
                          ) : (
                ...
                <DialogContent className="max-w-2xl">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <h4 className="mb-2">Tecnologias utilizadas:</h4>
